...
<template>
  <div id="mapviewbase">
    ...
    <template v-if="items.length==3" v-for="(item,index) in items">
      <mapview :id="item" :class="{'mapleftthree':index == 0,'mapright1three':index == 1,'mapright2three':index == 2}"></mapview>
    </template>
    <template v-if="items.length==4" v-for="(item,index) in items">
      <mapview :id="item" :class="{'mapleft1four':index == 0,'mapright1four':index == 1,'mapright2four':index == 2,'mapleft2four':index == 3}"></mapview>
    </template>
    <template v-if="items.length==5" v-for="(item,index) in items">
      <mapview :id="item" :class="{'mapleft1five':index == 0,'mapleft2topfive':index == 1,'mapright1five':index == 2,'mapright2five':index == 3,'mapleft2bottomfive':index == 4}"></mapview>
    </template>
    <template v-if="items.length==6" v-for="(item,index) in items">
      <mapview :id="item" :class="{'map1six':index == 0,'map2six':index == 1,'map3six':index == 2,'map4six':index == 3,'map5six':index == 4,'map6six':index == 5}"></mapview>
    </template>
    <template v-if="items.length==7" v-for="(item,index) in items">
      <mapview :id="item" :class="{'map1seven':index == 0,'map2seven':index == 1,'map3seven':index == 2,'map4seven':index == 3,'map5seven':index == 4,'map6seven':index == 5,'map7seven':index == 6}"></mapview>
    </template>
    <template v-if="items.length==8" v-for="(item,index) in items">
      <mapview :id="item" :class="{'map1eight':index == 0,'map2eight':index == 1,'map3eight':index == 2,'map4eight':index == 3,'map5eight':index == 4,'map6eight':index == 5,'map7eight':index == 6,'map8eight':index == 7}"></mapview>
    </template>
    <template v-if="items.length==9" v-for="(item,index) in items">
      <mapview :id="item" :class="{'map1nine':index == 0,'map2nine':index == 1,'map3nine':index == 2,'map4nine':index == 3,'map5nine':index == 4,'map6nine':index == 5,'map7nine':index == 6,'map8nine':index == 7,'map9nine':index == 8}"></mapview>
    </template>
    <component :is="current_com" :ref="current_com"></component>
  </div>
</template>
<script>
