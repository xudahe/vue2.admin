      ...
      <div class="transfer__body">
        ...
        <div class="transfer-pane">
          ...
          <div class="transfer-pane__tools">
            <el-input v-model="searchString" class="search-input" size="mini" type="search" placeholder="搜索人员" :disabled="!searchable"></el-input>
          </div>
          <!-- 穿梭框 -->
          <div class="transfer-pane__body">
            ...
            <el-tabs v-model="activeTabName" type="border-card" style="height:100%;overflow:auto;">
              <el-tab-pane v-for="(tab_item, idx) in tabConfig" :name="tab_item.tabKey" :label="tab_item.tabName" :key="idx">
                <el-tree :ref="tab_item.tabKey" lazy show-checkbox :props="{
                  ...
                  }" :load="onLoad" node-key="nodeId" :check-strictly="true" @check-change="(data, checked) => onCheckChange(data, checked, tab_item.tabKey)">
                </el-tree>
              </el-tab-pane>
            </el-tabs>
          </div>
...
import { DEP_CONFIG, ROLE_CONFIG, CONFIG_LIST } from './config'
