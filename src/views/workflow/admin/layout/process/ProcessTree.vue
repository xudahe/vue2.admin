<script>
//导入所有节点组件
import Approval from '@/views/workflow/common/process/nodes/ApprovalNode.vue'
import Cc from '@/views/workflow/common/process/nodes/CcNode.vue'
import Concurrent from '@/views/workflow/common/process/nodes/ConcurrentNode.vue'
import Condition from '@/views/workflow/common/process/nodes/ConditionNode.vue'
import Trigger from '@/views/workflow/common/process/nodes/TriggerNode.vue'
import Delay from '@/views/workflow/common/process/nodes/DelayNode.vue'
import Empty from '@/views/workflow/common/process/nodes/EmptyNode.vue'
import Root from '@/views/workflow/common/process/nodes/RootNode.vue'
import Node from '@/views/workflow/common/process/nodes/Node.vue'
...
export default {
  ...
  computed: {
    nodeMap() {
      return this.$store.state.workflow.nodeMap;
    },
    dom() {
      return this.$store.state.workflow.design.process;
    }
  },
  render(h, ctx) {
    console.log("渲染流程树")
